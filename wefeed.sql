...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mar. 13 mars 2018 à 09:03
...
INSERT INTO `sources` (`id`, `api_name`, `api_url`, `api_lang`) VALUES
(1, 'Libération', 'https://newsapi.org/v2/top-headlines?sources=liberation&apiKey=83644cf8558f42ea8a7c94bd4385dbbe', 'fr'),
(2, 'Le Monde', 'https://newsapi.org/v2/everything?sources=le-monde&apiKey=0a14f5a6544648f2ac680ea409807f2d', 'fr'),
(3, 'National Geographic', 'https://newsapi.org/v2/top-headlines?sources=national-geographic&apiKey=4a1c39e657c74e2ba04c3a5cdef68fe5', 'en'),
(4, 'The Times of India', 'https://newsapi.org/v2/top-headlines?sources=the-times-of-india&apiKey=83644cf8558f42ea8a7c94bd4385dbbe', 'en'),
(5, 'BBC News', 'https://newsapi.org/v2/top-headlines?sources=bbc-news&apiKey=0a14f5a6544648f2ac680ea409807f2d', 'en');
...
(1, 'Thomas', 'oumar.thomas1998@gmail.com', '548723cea2899944af5f1d02c7bbc61afdb152d1', 'a:3:{i:0;s:11:\"Libération\";i:1;s:19:\"National Geographic\";i:2;s:8:\"BBC News\";}');
COMMIT;
